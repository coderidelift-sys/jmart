                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <select name="select_supplier" id="select_supplier" class="form-control" style="width: 100%;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap" style="width:100%" id="example2">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td style="text-align: right !important;" colspan="7" class="fw-bold text-uppercase text-start">Total Hutang</td>
...
<script>
    $(function() {
        ...
        $('#example2').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('laporan/pembelian_supplier_json'); ?>",
                "type": "POST",
                data: function(d) {
        ...
        $('#btn-pdf').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("laporan/pembelian_supplier_pdf"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        link.href = url;
                        link.download = 'laporan_pembelian_supplier.pdf'; // Atur nama file
        ...
        $('#btn-excel').click(function() {
            ...
            // Kirim data ke server menggunakan AJAX
            $.ajax({
                url: '<?php echo base_url("laporan/pembelian_supplier_excel"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        var link = document.createElement('a');
                        link.href = url;
                        link.download = 'pembelian_supplier.xlsx'; // Atur nama file
                        // Klik pada link untuk memicu unduhan
                        link.click();
                        // Hapus URL objek setelah unduhan selesai
                        window.URL.revokeObjectURL(url);

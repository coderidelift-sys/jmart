                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select style="width:100%" name="select_kasir" id="select_kasir" class="form-control">
                                 ...
                                 <div class="col-md-3 mb-3">
                                    <label class="form-label">Metode Pembayaran</label>
                                     <select style="width:100%" name="metode_bayar" id="metode_bayar" class="form-control">
...
<script>
    $(function() {
        ...
        $('#example2').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('laporan/penjualan_kasir_json'); ?>",
                "type": "POST",
                data: function(d) {
                    d.start_date = $('#start-date').val();
                    d.end_date = $('#end-date').val();
                    d.kasir = $('#select_kasir').val();
                    d.metode = $('#metode_bayar').val();
                },
        ...
        $('#btn-pdf').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("laporan/penjualan_kasir_pdf"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        link.href = url;
                        link.download = 'laporan_penjualan_kasir.pdf'; // Atur nama file
        ...
        $('#btn-excel').click(function() {
            ...
            // Kirim data ke server menggunakan AJAX
            $.ajax({
                url: '<?php echo base_url("laporan/penjualan_kasir_excel"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        var link = document.createElement('a');
                        link.href = url;
                        link.download = 'penjualan_kasir.xlsx'; // Atur nama file
                        // Klik pada link untuk memicu unduhan
                        link.click();
                        // Hapus URL objek setelah unduhan selesai
                        window.URL.revokeObjectURL(url);

							...
							<table class="table table-bordered table-hover" id="dataProduk" style="width: 100%;">
								<thead>
									<tr>
										...
										<th rowspan="2">Stock Aplikasi</th>
										<th rowspan="2">Stock Fisik</th>
										<th class="text-center" colspan="3">Selisih</th>
									</tr>
									<tr>
										<th class="text-center" style="border-left: none;">Jumlah</th>
								...
								<tbody>
									<?php
									$total_selisih_nilai_jual = 0;
									$total_modal = 0;

									foreach ($produk as $key => $value) :
										$selisih = $value['stock_fisik'] - $value['stock_aplikasi'];
										$nilai_jual = abs($selisih * $value['harga_saat_ini']);
										$total_selisih_nilai_jual += $nilai_jual;
										$total_modal += $value['hpp_barang'];
									?>
										<tr>
											<td><?= $key + 1 ?></td>
											...
											<td><?= $value['stock_fisik'] ?></td>
											<td class="text-center"><?= $selisih ?></td>
											<td><?= "Rp. " . number_format($value['hpp_barang']) ?></td>
											<td><?= "Rp. " . number_format($nilai_jual) ?></td>
										</tr>
									<?php endforeach ?>
								</tbody>
								...
								<tfoot>
									<tr>
										...
										<td class="fw-bold"><?= "Rp. " . number_format($total_modal) ?></td>
										<td class="fw-bold"><?= "Rp. " . number_format($total_selisih_nilai_jual) ?></td>
									</tr>
								</tfoot>
							</table>
						</div>

            ...
            <div class="col">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu bg-secondary">
                        <li>
                            <a href="<?= base_url('product/detail/' . $barang['id_brg']) ?>" class="dropdown-item small text-white">
                                Lihat Detail
                            </a>
                        </li>
                        <li>
...
<form action="<?= base_url('product/update') ?>" method="POST" enctype="multipart/form-data" id="form-product">
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <div class="col-12">
                                            ...
                                            <div class="ec-vendor-upload-detail">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control slug-title" id="nama_produk" name="nama_produk" value="<?= $barang['nama_barang'] ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="select_kategori" id="select_kategori" class="form-select">
                                                            ...
                                                            <?php foreach ($kategori as $key => $kt) : ?>
                                                                <option <?= $barang['id_kategori_brg'] == $kt['id_kategori_brg'] ? "selected" : "" ?> value="<?= $kt['id_kategori_brg'] ?>"><?= $kt['nama_kategori_brg'] ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-12">
                                                            <input id="barcode" name="barcode" class="form-control" type="text" value="<?= $barang['barcode'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="stock_brg" class="col-12 col-form-label">Stock Awal</label>
                                                        <div class="col-12">
                                                            <input id="stock_brg" name="stock_brg" class="form-control" type="text" value="<?= $barang['stock_brg'] ?>" disabled style="cursor: not-allowed;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-12">
                                                            <select name="select_satuan" id="select_satuan" class="form-select">
                                                                ...
                                                                <?php foreach ($satuan as $key => $st) : ?>
                                                                    <option <?= $barang['id_satuan'] == $st['id_satuan'] ? "selected" : "" ?> value="<?= $st['id_satuan'] ?>"><?= $st['nama_satuan'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="alert_quantity" name="alert_quantity" class="form-control" type="text" value="<?= $barang['alert_quantity'] ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="select_supplier" id="select_supplier" class="form-select">
                                                            ...
                                                            <?php foreach ($supplier as $key => $sp) : ?>
                                                                <option <?= $barang['id_supplier'] == $sp['id_supplier'] ? "selected" : "" ?> value="<?= $sp['id_supplier'] ?>"><?= $sp['nama_supplier'] ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="file" id="formFile" name="fileUpload" onchange="preview()" accept=".png,.jpg,.jpeg">
                                        ...
                                        <div class="table-responsive">
                                            <table class="border-0 text-nowrap">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="step_two">
                                                            <input type="text" class="form-control input-formatted-currency" id="hpp" name="hpp_barang" value="<?= $barang['hpp_barang'] ?>">
                                                        </td>
                                                        ...
                                                        <td class="step_three">
                                                            <input type="text" class="form-control" id="markup_barang" name="markup_barang" value="<?= $barang['markup_barang'] ?>">
                                                        </td>
                                                        <td class="center" width="40">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control input-formatted-currency" id="harga_jual_barang" name="harga_jual_barang" value="<?= $barang['harga_jual_barang'] ?>">
                                                        </td>
                                                        <td class="center" width="40">
                                                        ...
                                                        <td>
                                                            <select class="form-control select2" name="ppn_barang" id="ppn" value="<?= $barang['ppn_barang'] ?>">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control input-formatted-currency" name="total_jual" id="total_jual" value="<?= $barang['harga_jual_barang'] ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                        ...
                        <div class="card-footer justify-content-center align-items-center" style="border-top: 0 solid #e6e7e9 !important">
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="d-grid">
                                        <button type="submit" id="btn-submit" class="btn btn-primary btn-block" data-loading>
                                            ...
                                            <span id="btn-text">Ubah Data</span>
                                        </button>
                                    </div>
                                </div>
                            </div>

                ...
                <?php foreach ($pending as $key => $value) : ?>
                    ...
                    <li class="list-items pull_delete" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#detailPesananModal<?= $value['id_pesanan'] ?>">
                        <div class=" media">
							...
							<img src="<?= base_url(file_exists(FCPATH . 'public/template/upload/user/' . ($value['avatar'] ?? '')) && !empty($value['avatar']) 
								? 'public/template/upload/user/' . $value['avatar'] 
								: 'public/template/upload/user/default.png') ?>" alt="">
                            </div>

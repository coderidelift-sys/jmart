...
<div class="terms-tab-wrapper shadow">
    <div class="container">
        <ul class="nav row row--no terms-tab overflow-auto">
            ...
            <li class="nav-item col-3">
                <a class="nav-link active" id="Campaign-tab" data-toggle="tab" href="<?= base_url('pesanan/dikemas') ?>" role="tab" aria-controls="profile" aria-selected="false">Dikemas</a>
            </li>
            <li class="nav-item col-3">
            ...
            <li class="nav-item col-3">
                <a class="nav-link" id="Campaign-tab" data-toggle="tab" href="<?= base_url('pesanan/selesai') ?>" role="tab" aria-controls="profile" aria-selected="false">Selesai</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="horizontal-product-box">
                        ...
                        <div class="horizontal-product-details">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <h6 style="font-size: 12px;line-height: 1.2;margin-bottom: 0;" class="product-status bg-warning text-white">Dikemas</h6>
                            </div>
                            <div class="row">
                                <div class="col-auto">

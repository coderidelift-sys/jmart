      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="button mt-2">
               <button style="border-radius: 0px;" id="btn-pesanan" class="btn btn-primary w-100 btn-block" data-loading disabled>Buat Pesanan</button>
               <button style="border-radius: 0px;display:none" id="pay-button" class="btn btn-primary w-100 btn-block mt-2" data-loading disabled>Konfirmasi Pembayaran</button>
            </div>
         </div>
      </div>
   </div>

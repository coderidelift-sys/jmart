    ...
    <div class="container details-page">
        ...
        <div class="product-details" style="border-top: 2px dashed #ebebeb;">
            ...
            <div class="ratings mt-1">
                <div class="d-flex align-items-center gap-1">
					...
					?>
                    <h4 style="font-size: 14px;margin-bottom: 0;"><?= number_format($jumlah_jual) ?> Terjual | <?= $barang['stock_brg'] ?> Stok Tersedia</h4>
                </div>
            </div>
        ...
        <div class="row product-description mt-2">
            <div class="col-12">
                ...
                <div class="rating-and-review-wrapper bg-white py-3 mb-3 dir-rtl d-none">
                    <div class="container">

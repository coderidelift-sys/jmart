...
<footer class="footer-nav">
	<div class="container">
		<div class="row">
			<div class="col-2">
				<a href="#" class="footer-nav__link <?= $segment == 'home' ? '_active' : '' ?>">
					<i class="fa fa-home" style="font-size: 24px;margin-top: 10px;margin-bottom: 0px;"></i>
					<span style="font-size: 12px;">Home</span>
				</a>
			</div>
			<div class="col-2">
				<a href="#" class="footer-nav__link <?= $segment == 'keranjang' ? '_active' : '' ?>">

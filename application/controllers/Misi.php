...
class Misi extends CI_Controller
{
	...
	{
		$user = $this->session->userdata('id_user');
		$data['list'] = $this->M_Crud->all_data('tb_pesanan')->join('tb_user', 'tb_user.id_user = tb_pesanan.id_user')->where('status_pesanan', 'Dikirim')
	...
	{
		$user = $this->session->userdata('id_user');
		$data['pending'] = $this->M_Crud->all_data('tb_pesanan')->join('tb_user', 'tb_user.id_user = tb_pesanan.id_user')->where('status_pesanan', 'Dikemas')->where_in('jenis_order', ['dianterin', 'dianterin_pt'])->get()->result_array();

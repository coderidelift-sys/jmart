      ...
      <div class="col-md-6 mt-2">
        <div class="card">
          <a href="<?= base_url('misi/list') ?>">
            ...
            <div class="card-body text-center">
              <h5 class="card-title">Daftar Misi <span class="text-danger fw-bold">[<?= $misi['total_data'] ?> Aktif]</span></h5>
            </div>
          </a>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center">
              ...
              <div>
                ...
                <p style="margin-top:-10px" class="card-text fw-bold fs-3"><?= $success['total_data'] ?></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body bg-primary text-white">
            <div class="d-flex justify-content-start align-items-center">
              ...
              <div>
                ...
                <p style="margin-top:-10px" class="card-text fw-bold fs-3"><?= $pending['total_data'] ?></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center">
              ...
              <div>
                ...
                <p style="margin-top:-10px" class="card-text fw-bold fs-3"><?= $misi['total_data'] ?></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center">
              ...
              <div>
                ...
                <p style="margin-top:-10px" class="card-text fw-bold fs-3">Rp. <?= isset($setoran['total_pembayaran']) ? $setoran['total_pembayaran'] : '0'; ?>
                </p>
              </div>
            </div>
          </div>

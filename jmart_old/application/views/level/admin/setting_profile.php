                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="mb-2">
                                                            <img src="https://live.aplikasi-spa.com/media/images/account/photo.png" id="preview-image" class="avatar avatar-xl img-zoom" draggable="false">
                                                        </div>
                                                        <button type="button" id="btn-remove-image" class="btn btn-danger btn-sm mb-2" style="min-width: 112px; display: none">
                                                            Hapus Foto
                                                        </button>
                                                        <input type="file" id="load-photo" class="form-control" accept=".png, .jpg, .jpeg">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">

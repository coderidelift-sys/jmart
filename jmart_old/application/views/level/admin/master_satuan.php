        ...
        <div class="card">
          ...
          <div class="card-body p-3">
            <div class="table-responsive">
              <table class="table table-hover" id="dataSatuan" style="width: 100%;">
                <thead>
                  <tr>
                    <th width="7">No</th>
                    <th>Nama Satuan</th>
      ...
      <form id="formUbahSatuan" method="POST" onsubmit="return simpanPerubahanSatuan();">
        <div class="modal-body pt-4 pb-2 px-4">
          <div class="text-center mb-3">
            ...
            <h2 id="modal-title" class="mt-2">Edit Satuan</h2>
          </div>
          <div class="mb-3">
...
<div class="modal fade" id="deleteSatuanModal" tabindex="-1" aria-modal="true" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <div class="text-secondary">Data satuan yang sudah pernah digunakan tidak dapat dilakukan penghapusan. Harap konfirmasi kepada Super Administrator!!</div>
      </div>
...
<script>
  ...
  function deleteSatuan(link) {
    ...
    $('#btn-delete-submit').off('click').on('click', function() {
      ...
      // Ajax untuk menghapus data Satuan
      $.ajax({

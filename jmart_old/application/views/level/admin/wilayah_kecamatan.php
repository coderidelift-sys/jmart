      ...
      <div class="col-12 col-md-6">
        <div class="card">
          ...
          <form method="POST" id="form-simpan">
            <div class="card-body">
              <div class="mb-3">
                <label class="fw-bold form-label" required>Pilih Provinsi</label>
                <div>
              ...
              <div class="mb-3">
                <label class="form-label fw-bold required">Nama Kecamatan</label>
                <div>
                  <input required type="text" class="form-control" aria-describedby="emailHelp" placeholder="Nama Kecamatan" id="nama_kecamatan" name="nama_kecamatan">
                </div>
              </div>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card">
          ...
          <div class="card-body p-3">
            <div class="table-responsive">
              <table class="table table-hover" id="dataKecamatan" style="width: 100%;">
                <thead>
                  <tr>
                    <th width="7">No</th>
                    <th>Nama Provinsi</th>
      ...
      <form id="formUbahKecamatan" method="POST" onsubmit="return simpanPerubahanKecamatan();">
        <div class="modal-body pt-4 pb-2 px-4">
          <div class="text-center mb-3">
            ...
            <h2 id="modal-title" class="mt-2">Edit Kecamatan</h2>
          </div>
          <div class="mb-3">
...
<div class="modal fade" id="deleteKecamatanModal" tabindex="-1" aria-modal="true" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <div class="text-secondary">Data kecamatan yang sudah pernah digunakan tidak dapat dilakukan penghapusan. Harap konfirmasi kepada Super Administrator!!</div>
      </div>

...
<div class="terms-tab-wrapper shadow">
    <div class="container">
        <ul class="nav row row--no terms-tab overflow-auto">
            ...
            <li class="nav-item col-3">
                <a class="nav-link active" id="Campaign-tab" data-toggle="tab" href="<?= base_url('pesanan/dikirim') ?>" role="tab" aria-controls="profile" aria-selected="false">Dikirim</a>
            </li>
            <li class="nav-item col-3">
                    ...
                    <div class="horizontal-product-box">
                        ...
                        <div class="horizontal-product-details">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <h6 style="font-size: 12px;line-height: 1.2;margin-bottom: 0;" class="product-status">Dikirim</h6>
                            </div>

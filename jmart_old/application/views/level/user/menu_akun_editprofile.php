			...
			<div class="card-body">
				<form method="POST" id="updateBiodata" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<input name="nomor_induk" type="text" class="input" id="nomor_induk" placeholder="Nomor Induk Karyawan" aria-label="Nomor Induk Karyawan" aria-describedby="basic-icon-default-fullname2" value="<?= $user['nomor_induk'] ?>">
					</div>
					<div class="mb-3">

    ...
    <div class="container">
        <ul class="nav row row--no terms-tab overflow-auto">
            <li class="nav-item col-6">
                <a class="nav-link active" id="Donasi-tab" data-toggle="tab" href="<?= base_url('pesanan/autodebit') ?>" role="tab" aria-controls="home" aria-selected="true">Belum Lunas</a>
            </li>
            <li class="nav-item col-6">
                <a class="nav-link" id="Campaign-tab" data-toggle="tab" href="<?= base_url('pesanan/autodebit/lunas') ?>" role="tab" aria-controls="profile" aria-selected="false">Lunas</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="horizontal-product-box">
                        ...
                        <div class="horizontal-product-details">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <h6 style="font-size: 12px;line-height: 1.2;margin-bottom: 0;" class="product-status bg-danger text-white">Pending</h6>
                            </div>
                            <div class="row">
                                <div class="col-auto">

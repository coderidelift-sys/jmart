        ...
        <div class="card" style="background-image: url('public/template/img/illustrations/path-card.svg');background-position: bottom right;background-repeat: no-repeat;">
            <div class="card-header" style="justify-content: space-between;">
                <div class="avatar-container">
                    <img src="<?= base_url('public/template/upload/user/' . $user['avatar']) ?>" class="avatar avatar--large profile-kad__avatar shadow" onerror="this.src='http://localhost/auth/public/template/upload/user/c0e7bdead624a4dc11b5fdd315d2248a_(1).jpg'">

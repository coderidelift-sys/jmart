                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="start-date" name="start_date" placeholder="Tanggal Mulai">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Tanggal Berakhir</label>
                                    <input type="date" class="form-control" id="end-date" name="end_date" placeholder="Tanggal Berakhir">
                                </div>
...
<script>
    $(function() {
        ...
        $('#example2').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('laporan/pembelian_barang_json'); ?>",
                "type": "POST",
                data: function(d) {
        ...
        $('#btn-pdf').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("laporan/pembelian_barang_pdf"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        link.href = url;
                        link.download = 'laporan_pembelian_barang.pdf'; // Atur nama file
        ...
        $('#btn-excel').click(function() {
            ...
            // Kirim data ke server menggunakan AJAX
            $.ajax({
                url: '<?php echo base_url("laporan/pembelian_barang_excel"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        var link = document.createElement('a');
                        link.href = url;
                        link.download = 'pembelian_barang.xlsx'; // Atur nama file
                        // Klik pada link untuk memicu unduhan
                        link.click();
                        // Hapus URL objek setelah unduhan selesai
                        window.URL.revokeObjectURL(url);

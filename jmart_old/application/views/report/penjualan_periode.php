                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <select name="" id="status_pembayaran" class="form-select">
                                        <option value="">**Semua</option>
                                        <option value="Menunggu Pembayaran">Belum Lunas</option>
                                ...
                                <table class="table table-hover text-nowrap" style="width:100%" id="example2">
                                    <thead>
                                        <tr class="bg-gradient-info">
                                            ...
                                            <th class="text-center text-uppercase" width="20%">Jenis Order</th>
                                            <th class="text-center text-uppercase" width="20%">Metode Bayar</th>
                                            <th class="text-center text-uppercase" width="20%">Ongkos Kirim</th>
                                            <th class="text-center text-uppercase" width="20%">Total Penjualan</th>
                                            <th class="text-center text-uppercase" width="20%">Status Pesanan</th>
                                            <th class="text-center text-uppercase" width="20%">Status Pembayaran</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<script>
    $(function() {
        ...
        $('#example2').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('laporan/penjualan_periode_json'); ?>",
                "type": "POST",
                data: function(d) {
                    d.start_date = $('#start-date').val();
                    d.end_date = $('#end-date').val();
                    d.status = $('#status_pembayaran').val();
                },
        ...
        $('#btn-pdf').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("laporan/penjualan_periode_pdf"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        link.href = url;
                        link.download = 'laporan_penjualan_periode.pdf'; // Atur nama file
        ...
        $('#btn-excel').click(function() {
            ...
            // Kirim data ke server menggunakan AJAX
            $.ajax({
                url: '<?php echo base_url("laporan/penjualan_periode_excel"); ?>',
                method: 'POST',
                data: {
                    start: startDate,
                    end: endDate,
    ...
    if (typeof hideLoading === 'function') hideLoading();
                ...
                success: function(response, status, xhr) {
                    ...
                    if (response instanceof Blob) {
                        ...
                        var link = document.createElement('a');
                        link.href = url;
                        link.download = 'penjualan_periode.xlsx'; // Atur nama file
                        // Klik pada link untuk memicu unduhan
                        link.click();
                        // Hapus URL objek setelah unduhan selesai
                        window.URL.revokeObjectURL(url);

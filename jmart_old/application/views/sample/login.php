...
<body>
    <div class="page-wraper">
            ...
            <div class="container">
                <div class="account-area">
                    <form class="">
                        ...
                        <div class="input-group">
                            <a href="index.html" class="btn mt-2 btn-primary w-100 btn-rounded">Login</a>
                        </div>
                    </form>
                    ...
                    <div class="social-btn-group text-center">
                        <a href="https://www.google.com/" target="_blank" class="social-btn"><img src="https://jobie.dexignzone.com/mobile-app/xhtml/assets/images/social/google.png" alt="socila-image"></a>
                        <a href="https://www.facebook.com/" target="_blank" class="social-btn ms-3"><img src="https://jobie.dexignzone.com/mobile-app/xhtml/assets/images/social/facebook.png" alt="social-image"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer class="footer fixed">
            <div class="container">
                <a href="<?= base_url('home/register') ?>" class="btn btn-primary light btn-rounded text-primary d-block">Create account</a>
            </div>
        </footer>
        <!-- Footer End -->
